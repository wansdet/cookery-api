 ...
 */
final class Version20230521115344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, region_code VARCHAR(20) DEFAULT NULL, user_id INT NOT NULL, cooking VARCHAR(4000) DEFAULT NULL, cooking_time SMALLINT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, ingredients VARCHAR(1000) NOT NULL, preparation VARCHAR(4000) DEFAULT NULL, preparation_time SMALLINT DEFAULT NULL, recipe_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', servings SMALLINT DEFAULT NULL, status VARCHAR(20) NOT NULL, title VARCHAR(50) NOT NULL, vegan TINYINT(1) DEFAULT NULL, vegetarian TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_DA88B13759D8A214 (recipe_id), INDEX IDX_DA88B137AEB327AF (region_code), INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
